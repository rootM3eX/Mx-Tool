...
figlet -f slant  Attack Of Cyber | lolcat

echo -e  $white"_____________________________________________________________"
echo -e  $white "Tools    : Mx-Tool $white         " |lolcat
echo -e  $white "Creadby  : root@M3e.X..!?/.># $white   " |lolcat
echo -e  $white "Contact  : attackofcyber969@gmail.com $white " |lolcat
echo -e  $white "Team     : Attack Of Cyber     $white  " |lolcat
echo -e  $white"———————————————————————————————————————————————————————"
...
echo -e $cyan"[#]> Thanks All Member AOC"
sleep 1
echo ""
